...
const Projects = ({techs}) => {
    ...
    return (
        <div id="projects" className="min-h-screen w-screen px-10 sm:px-20 lg:px-32 flex flex-col items-center justify-start gap-20 pb-20 pt-20">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                ...
                <RevealText
                    ...
                    duration={0.2}
                    delayTime={0.01}
                    extraClass="font-semibold text-lg text-slate-500"
                />
            </div>
            <div className="flex flex-col items-center justify-center gap-20 w-full">
                <div className="flex md:flex-row flex-col items-center w-full justify-center gap-10">
                    <ProjectCard
                        techs={techs}
                    ...
                    <ProjectCard
                        ...
                        description="A Notes Application to capture your thoughts, organize your ideas, and turn inspiration into action."
                    />
                </div>
                <div className="flex md:flex-row flex-col items-center w-full justify-center gap-10">
                    <ProjectCard
                    ...
                    <ProjectCard
                        ...
                        description="Admin Dashboard for empowering your decisions with insights, control, efficiency at your fingertips."
                    />
                </div>
            </div>
        </div>
